<div class="main-menu-content">
  <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <ul class="menu-content" style="">
      ...
      <li class=""><a class="menu-item" href="{{ URL::to('category/')}}" data-i18n="nav.dash.ecommerce">Category</a></li>
  ...
  <ul class="menu-content" style="">
    <li class=""><a class="menu-item" href="" data-i18n="nav.footers.footer_light">Footer Light</a> </li>
    <li class=""><a class="menu-item" href="" data-i18n="nav.footers.footer_dark">Footer Dark</a> </li>
    <li class=""><a class="menu-item" href="" data-i18n="nav.footers.footer_transparent">Footer Transparent</a> </li>
  </ul>
</li>
<li class="nav-item"><a href="#"><i class="la la-repeat"></i><span class="menu-title" data-i18n="nav.form_repeater.main">Form Repeater</span></a> </li>
